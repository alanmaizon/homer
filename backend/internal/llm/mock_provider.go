...
func (m *MockProvider) Summarize(_ context.Context, docs []domain.Document, style string, instructions string) (string, error) {
...
func (m *MockProvider) Rewrite(_ context.Context, text string, mode string, instructions string) (string, error) {
